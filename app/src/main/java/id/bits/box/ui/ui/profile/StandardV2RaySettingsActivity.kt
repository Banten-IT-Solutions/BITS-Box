...
import id.bits.box.proxy.PreferenceBinding
import id.bits.box.proxy.PreferenceBindingManager
import id.bits.box.proxy.Type
...
abstract class StandardV2RaySettingsActivity : ProfileSettingsActivity<StandardV2RayBean>() {
    ...
    override fun PreferenceFragmentCompat.createPreferences(
        ...
        type.preference.isVisible = true
        uuid.preference.isVisible = true
        ...
        username.preference.isVisible = false
        password.preference.isVisible = false
        ...
        encryption.preference.apply {
            ...
            if (isVless) {
                ...
                setEntries(R.array.xtls_flow_display)
                setEntryValues(R.array.xtls_flow_value)
            } else {
                setEntries(R.array.vmess_encryption_display)
