...
class QRCodeDialog() : DialogFragment() {
    ...
    companion object {
        private const val KEY_URL = "id.bits.box.QRCodeDialog.KEY_URL"
        private const val KEY_NAME = "id.bits.box.QRCodeDialog.KEY_NAME"
        private val iso88591 = StandardCharsets.ISO_8859_1.newEncoder()
    }

    /** Use the app's dialog theme variant so the QR dialog matches all other dialogs. */
    override fun getTheme(): Int = Theme.getDialogTheme()
