package id.bits.box.fmt.shadowsocks
...
fun buildSingBoxOutboundShadowsocksBean(bean: ShadowsocksBean, defaultServerDomainStrategy: String): SingBoxOptions.Outbound_ShadowsocksOptions {
