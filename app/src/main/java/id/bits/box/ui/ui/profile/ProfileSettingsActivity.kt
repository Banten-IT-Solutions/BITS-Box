...
abstract class ProfileSettingsActivity<T : AbstractBean>(
    ...
    val proxyEntity by lazy { BitsBoxDatabase.proxyDao.getById(DataStore.editingId) }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menu.findItem(R.id.action_move)?.apply {
            if (DataStore.editingId != 0L // not new profile
                && BitsBoxDatabase.groupDao.getById(DataStore.editingGroup)?.type == GroupType.BASIC // not in subscription group
                    ...
                    BitsBoxDatabase.groupDao.allGroups()
                        ...
                        .forEach { group ->
                            LayoutGroupItemBinding.inflate(layoutInflater, this, true).apply {
                                ...
                                groupType.text = getString(R.string.group_basic)
