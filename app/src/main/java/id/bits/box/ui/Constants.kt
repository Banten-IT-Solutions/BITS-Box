...
object Key {
    ...
    const val DB_PROFILE = "bits_box.db"
    ...
    const val RULES_VARIANT = "rulesVariant"
    const val GEOIP_DOWNLOADED_VARIANT = "geoipDownloadedVariant"
    const val GEOSITE_DOWNLOADED_VARIANT = "geositeDownloadedVariant"
...
object Action {
    const val SERVICE = "id.bits.box.SERVICE"
    const val CLOSE = "id.bits.box.CLOSE"
    const val RELOAD = "id.bits.box.RELOAD"

    // const val SWITCH_WAKE_LOCK = "id.bits.box.SWITCH_WAKELOCK"
    const val RESET_UPSTREAM_CONNECTIONS = "id.bits.box.RESET_UPSTREAM_CONNECTIONS"
}
