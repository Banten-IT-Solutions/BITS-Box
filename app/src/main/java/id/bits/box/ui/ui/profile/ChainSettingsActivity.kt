...
import id.bits.box.databinding.LayoutAddEntityBinding
import id.bits.box.databinding.LayoutProfileBinding
import id.bits.box.fmt.internal.ChainBean
import id.bits.box.ktx.*
import id.bits.box.ui.ProfileSelectActivity
...
class ChainSettingsActivity : ProfileSettingsActivity<ChainBean>(R.layout.layout_chain_settings) {
    ...
    inner class ProfileHolder(binding: LayoutProfileBinding) :
        ...
        fun bind(proxyEntity: ProxyEntity) {
            ...
            profileType.setChipBackgroundColor(ColorStateList.valueOf(getProtocolColor(proxyEntity.type)))
