...
public class SingBoxOptions {
    ...
    public static class SingBoxOption {
        ...
        public Map<String, Object> asMap() {
            return (Map<String, Object>) (Object) gsonSingbox.fromJson(gsonSingbox.toJson(this), Map.class);
        }
    ...
    public static final class CustomSingBoxOption extends SingBoxOption {
        ...
        public Map<String, Object> getBasicMap() {
            Map<String, Object> map = (Map<String, Object>) (Object) gsonSingbox.fromJson(config, Map.class);
            if (map == null) {
                map = new HashMap<>();
            }
            return map;
    ...
    public static class SingBoxOptionSerializer implements JsonSerializer<SingBoxOption> {
        ...
        public JsonElement serialize(SingBoxOption src, Type typeOfSrc, JsonSerializationContext context) {
            ...
            // 使用反射获取所有非 transient 字段（包含父类字段）
            Class<?> clazz = src.getClass();
            while (clazz != null && clazz != SingBoxOption.class) {
                addFields(map, clazz.getDeclaredFields(), src);
                clazz = clazz.getSuperclass();
            }
            // 处理 SingBoxOption 基类字段
            addFields(map, SingBoxOption.class.getDeclaredFields(), src);
            // 合并 hack 字段
            if (src instanceof CustomSingBoxOption) {
                Map<String, Object> basicMap = ((CustomSingBoxOption) src).getBasicMap();
                if (basicMap != null) {
                    map.putAll(basicMap);
                }
            }
        ...
        private void addFields(Map<String, Object> map, java.lang.reflect.Field[] fields, SingBoxOption src) {
            for (java.lang.reflect.Field field : fields) {
                ...
                try {
                    ...
                    if (value != null) {
                        // 使用 @SerializedName 注解的值作为 JSON key（如果存在）
                        String jsonName = field.getName();
                        com.google.gson.annotations.SerializedName ann = field.getAnnotation(com.google.gson.annotations.SerializedName.class);
                        if (ann != null) {
                            jsonName = ann.value();
                        }
    ...
    public static class DNSServerOptions extends SingBoxOption {
        ...
        public Map<String, Object> domain_resolver;
    ...
    public static class RouteOptions extends SingBoxOption {
        ...
        public Map<String, Object> default_domain_resolver;
