...
// Copied from v2rayNG for legacy format compatibility

object NGUtil {

    /**
     * Convert string to Editable for Kotlin TextView usage
     *
    ...
    /**
     * Parse string to integer, returns 0 on error
     */
    fun parseInt(str: String): Int {
        return try {
            Integer.parseInt(str)
        } catch (e: Exception) {
            Logs.e("parseInt error: ${e.message}")
            0
        }
    }
    ...
    /**
     * Get application package path (base directory)
     */
    ...
    /**
     * Read text content from assets file
     */
