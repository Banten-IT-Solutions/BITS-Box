...
require (
	// Upstream go.mod still declares legacy module path; local replace uses BITS-Box-Core checkout.
	github.com/Banten-IT-Solutions/bits-box-core v1.0.0 // replaced
...
replace github.com/Banten-IT-Solutions/bits-box-core => ../external/bits-box-core

replace github.com/sagernet/sing-box => ../external/sing-box
